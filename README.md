...
- Floating **Reply Later** / **Set Aside** buttons stack vertically — no overlap
- Toast sits above the dock so it doesn’t collide
- Main content has bottom padding so calendars/habits aren’t covered
